...
public:
    CMainParams()
    {
        ...
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("oryxcoin1.oryxian.net", "oryxcoin4.oryxian.net"));
        vSeeds.push_back(CDNSSeedData("oryxcoin2.oryxian.net", "oryxcoin5.oryxian.net"));
        vSeeds.push_back(CDNSSeedData("oryxcoin3.oryxian.net", "oryxcoin6.oryxian.net"));

        // Oryxcoin addresses start with 'o'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 115);
        // Oryxcoin script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Oryxcoin private keys start with 'K'
        ...
        strMasternodePoolDummyAddress = "oSJVWUkt6HtSCY2SaJ2akeyJUg8bg1hW3S";
...
public:
    CTestNetParams()
    {
        ...
        // Testnet Oryxcoin addresses start with 'g'
