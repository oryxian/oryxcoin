...
#   c) node1 mines 32 blocks, so now node 0 has 500000ORYX, node 1 has 4250ORYX, node2 has none.
#   d) node0 sends 601 ORYX to node2, in two transactions (301 ORYX, then 300 ORYX).
