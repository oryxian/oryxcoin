Contributing to Oryxcoin Core
==================================

The Oryxcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Oryxcoin Core project, and is not to be
confused with overall Oryxcoin Network Protocol consensus changes.

Whether a pull request is merged into Oryxcoin Core rests with the project merge
...
Patches that change Oryxcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Oryxcoin consensus, it must have been
...
The project leader is the release manager for each Oryxcoin Core release.
