...
In order to support loading of multiple wallets in oryxcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is oryxcoin.cpp.
...
Changes to oryxcoin.cpp
----------------------
oryxcoin.cpp is the entry point into oryxcoin-qt, and as such, will require some minor modifications to provide hooks for
