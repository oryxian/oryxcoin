...
This mechanism has been integrated into Bitcore-Node-Oryxcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/oryxcoin/insight-api-oryxcoin#web-socket-api](https://github.com/oryxcoin/insight-api-oryxcoin#web-socket-api)
* API: [https://github.com/oryxcoin/insight-api-oryxcoin#swifttx-transactions](https://github.com/oryxcoin/insight-api-oryxcoin#swifttx-transactions)
...
By default, the Oryxcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Oryxcoin Core daemon:
